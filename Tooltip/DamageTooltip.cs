...
namespace EnhancedTooltip.Tooltip
{
	public class DamageTooltip
	{
		public static TwoColumnLine GetLine(DrawableTooltipLine line, Item item)
		{
			...
			return new TwoColumnLine(textDamage, ((int)itemDamage).ToString(), line.color, TheOneLibrary.Utility.Utility.DoubleLerp(Color.Red, Color.Yellow, Color.Lime, item.damage / (float)EnhancedTooltip.Instance.maxDamage), line.baseScale);
		}
	}
}